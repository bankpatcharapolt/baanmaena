  ...
  <section class="sample-text-area">
            ...
            <div class="row">
                <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6" id="contact">
                    <h3 class="text-heading title_color  " style="color:#ffb606;">ติดต่อเรา</h3>
                        <h5>
                           ร้านขนมแม่นา ซอยลาดพร้าว 110 แยก4 แขวง พลับพลา เขตวังทองหลาง กรุงเทพมหานคร 10310
        ...
        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6" >
                <section style="padding-bottom: 0px;padding-top: 0px;">
                    ...
                    src="https://www.google.com/maps/embed/v1/place?key=AIzaSyCZEVlFGU3e-IavlW5izHVeGY3dEpfZchE&q=ลาดพร้าว+110+แยก+4" allowfullscreen>
                    </iframe>
