            ...
            <div class="row">
                <div class="col-md-5">
                    <div class="section-top">
                        <h3><span class="style-change">เมนู</span> <br>อาหาร&เบเกอรี่ โฮมเมด</h3>
                        <p class="pt-3" style="font-size:20px;">อาหารพื้นบ้านสไตล์ไทย รวมถึงขนมอาทิเช่น ทองหยิบ,ทองหยอด,คุกกี้</p>
                    </div>
                </div>
            </div>
            <div class="row">
